...
function findMaxMinAvg(input) {
    ...
    maxMinAvg.push(max, min, avg);

    return maxMinAvg;
}
var h = [1, 5, 10, -2];
console.log("The original array: [" + h + "]");
var getMMA = findMaxMinAvg(h);
console.log("The max, min, and avg of the array is: [" + getMMA + "]");
readability();
...
// I used `h` again here because it was the same array in both the last prompt and the current
swapValues(h);
readability();
